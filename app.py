...
def generar_pdf_profesional_test(df_pdf):
    ...
    def crear_card_kpi(titulo, valor, subtitulo):
        card = Table(
            ...
            colWidths=[1.48 * inch],
            rowHeights=[0.23 * inch, 0.36 * inch, 0.21 * inch]
        )
    ...
    parte_superior = Table(
        [[
            bloque_titulo,
            crear_card_kpi("AHORRO MENSUAL", money(first["Ahorro mensual"]), "Con PayZen"),
            crear_card_kpi("AHORRO ANUAL", money(first["Ahorro anual"]), "Con PayZen"),
            ...
            crear_card_kpi("COSTO PASARELA ACTUAL", money(first["Pasarela actual"]), "Modelo actual"),
            crear_card_kpi("COSTO PAYZEN + ADQ.", money(first["PayZen"]), "PayZen + adquirientes"),
        ]],
        colWidths=[
            3.25 * inch,
            1.55 * inch,
